...
export function Tooltip({ x, y, data, offsetX, offsetY }: TooltipProps) {
  return (
    <div
      className={`fixed z-50 w-60 border bg-white shadow-lg`}
    ...
    >
      ...
      <div className="border-t border-dashed border-blue-950 px-2.5 pt-2 text-xs leading-5 font-semibold text-blue-950">
        {data['简介']}
      </div>
      <div className="px-2.5 pt-1 pb-2 text-[0.7rem] text-blue-950/70">
        上述专业简介由AI生成，仅供参考
      </div>
    </div>
  )
